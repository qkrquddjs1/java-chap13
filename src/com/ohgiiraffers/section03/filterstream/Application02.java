...
public class Application02 {
    public static void main(String[] args) {
        /* InputsteramReader, OutputSteramWriter : 형변환 보조스트림
        * 형변환 보조 스트림에 대해 이해하고 사용할수 있다.
        *  기본 스트림이  byte 기반이고, 보조 스트림이 char 기반 스트림인 경우 사용한다. */

        /* 표준 스트림
        *  자바에서는 콘솔이나 키보드 같은 표준 입출력장치로부터 데이터를 입출력하깅 위한 스트림을
        ...
        *  즉, 자주 사용되는 자원(콘솔)에 대해 미리 스트림을 생성해 두었기때문에 개발자가 별도로 스트림을 생성하지 않아도 된다.
        * */

        /* System.in을 InputStreamReader로 변환하여 byte 기반 스트림을 char 기반 스트림으로 변환 한뒤
